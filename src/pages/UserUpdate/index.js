...
function UserUpdate() {
  ...
  async function handleSubmit(data){
    ...
    data.patient.birthday = parse(data.patient.birthday, 'dd/MM/yyyy', new Date())
    try{
      await api.put(`/patient/${id}/update`, data, {headers: {
        authorization: token
      }});
    } catch(err){
      alert('Não foi possível alterar os dados do paciente! Tente novamente mais tarde.');
      console.log(err);
    ...
    <div className="row container">
      ...
      <div className="row">
        <Form onSubmit={handleSubmit} ref={formRef} className="col s12">
          ...
          <legend>Dados pessoais</legend>
            <div className="row">
              ...
              <div class="input-field col s12 m6">
                <select value={formSelect.genre} name="genre" defaultChecked={formSelect.genre} onChange={handleChangeSelect}>
              ...
              <div className="row">       
              <div class="input-field col s12 m6">
                <select value={formSelect.risk} name="risk" defaultChecked={formSelect.risk} onChange={handleChangeSelect} >
              ...
              <div class="input-field col s12 m6">
                <select value={formSelect.status} name="status" defaultChecked={formSelect.status} onChange={handleChangeSelect} >
                  <option value="suspect">suspeito</option>
                  <option value="monitored">monitorado</option>
                  <option value="infected">infectado</option>
                  <option value="discarded_by_isolation">descartado por tempo de isolamento</option>
          ...
          <div className="row">
            <div className="col s12">
              <button type="submit" className="btn green right">Atualizar cadastro <i className="material-icons right">send</i> </button>
            </div>
          </div>
        </Form>
      </div>
